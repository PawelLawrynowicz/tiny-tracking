...
from ssdmobilenet import ssdlite_mobilenet_v2_inference
...
models = {
    ...
    'ssdmobilenet': ssdlite_mobilenet_v2_inference,  # broken
    'ssdmobiledet': ssdlite_mobiledet_inference,
    'efficientdet': efficientdet_inference
}

chosen_model = 'efficientdet'
...
OUT_FILE = f'predictions_{chosen_model}.json'
...
plt.savefig(f'f32_prc_{chosen_model}.png', dpi=300, bbox_inches='tight')
