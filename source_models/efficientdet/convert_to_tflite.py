...
model = tf.saved_model.load('./efficientdet_lite0_detection_1')
...
tf.saved_model.save(model,
                    'efficientdet_lite0_detection_1_with_signatures',
                    signatures={'predict': predict_concrete_fn}
                    )

# Convert to TFLite
converter = tf.lite.TFLiteConverter.from_saved_model(
    './model_with_signature')  # path to the SavedModel directory
